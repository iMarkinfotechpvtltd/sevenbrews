...
<div class="image-block skinny-sr">
<a href="<?php echo esc_url(get_sub_field('image_link')); ?>"><img src="<?php echo esc_attr(get_sub_field('image')); ?>" alt="product">
<?php $img_id=pippin_get_image_id( get_sub_field('image'));
$image = get_post($img_id);
$image_caption = $image->post_excerpt;
?>
<span class="img-caption"><?php echo $image_caption; ?></span>    
</a></div>
