...
?>
<div class="summary-block <?php if ( WC()->customer->has_calculated_shipping() ) echo 'calculated_shipping'; ?>">

	<?php do_action( 'woocommerce_before_cart_totals' ); ?>

	<h3><?php _e( 'Cart Totals', 'woocommerce' ); ?></h3>

	<table cellspacing="0" class="bill">
<thead>
		<tr>
			<th><?php _e( 'Subtotal', 'woocommerce' ); ?></th>
			<th data-title="<?php _e( 'Subtotal', 'woocommerce' ); ?>"><em class="price"><?php wc_cart_totals_subtotal_html(); ?></em></th>
		</tr>
</thead>
...
<tfoot>
		...
		<tr>
			...
			<td data-title="<?php _e( 'Total', 'woocommerce' ); ?>"><em class="price"><?php wc_cart_totals_order_total_html(); ?></em></td>
		</tr>
